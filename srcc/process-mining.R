...
data <- readr::read_csv('./data/processmining-bupaR-master/processmining-bupaR-master/00-data/loanapplicationfile.csv',
...
#ggsave('./output/03_pm-bupar_process precedence matrix.png', precedence_matrix)
...
#ggsave('./output/04_pm-bupar_trace explorer.png', trace_explorer, width = 12)
rm(trace_explorer)
...
#ggsave('./output/06_pm-bupar_resource matrix.png', resource_matrix)
rm(resource_matrix)
...
#ggsave('./output/08_pm-bupar_throughput application type.png', plot)
rm(plot)
...
#ggsave('./output/09_pm-bupar_throughput loan goal.png', plot)
rm(plot)
